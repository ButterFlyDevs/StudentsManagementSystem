# -*- coding: utf-8 -*-
#
# MicroServicio Base de Datos documentation build configuration file, created by
...
# http://www.sphinx-doc.org/es/stable/ext/intersphinx.html

extensions = ['sphinx.ext.intersphinx']
intersphinx_mapping = {'python': ('http://docs.python.org/2.7', None),
                       'backend': ('../../SMS-Back-End/docs/build/html/', None)}