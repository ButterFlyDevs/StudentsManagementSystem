...
_FILEOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='go_force_proto2_api', full_name='proto2.FileOptions.go_force_proto2_api', index=29,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='java_enable_maps_for_proto2', full_name='proto2.FileOptions.java_enable_maps_for_proto2', index=30,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='objc_class_prefix', full_name='proto2.FileOptions.objc_class_prefix', index=31,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='csharp_namespace', full_name='proto2.FileOptions.csharp_namespace', index=32,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='javanano_use_deprecated_package', full_name='proto2.FileOptions.javanano_use_deprecated_package', index=33,
